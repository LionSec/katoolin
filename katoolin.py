...
0) Install all Information Gathering tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in acccheck ace-voip amap automater braa casefile cdpsnarf cisco-torch cookie-cadger copy-router-config dmitry dnmap dnsenum dnsmap dnsrecon dnstracer dnswalk dotdotpwn enum4linux enumiax exploitdb fierce firewalk fragroute fragrouter ghost-phisher golismero goofile lbd maltego-teeth masscan metagoofil miranda nmap p0f parsero recon-ng set smtp-user-enum snmpcheck sslcaudit sslsplit sslstrip sslyze thc-ipv6 theharvester tlssled twofi urlcrazy wireshark wol-e xplico ismtp intrace hping3; do apt-get -f install -y $i; done && wget http://www.morningstarsecurity.com/downloads/bing-ip2hosts-0.4.tar.gz && tar -xzvf bing-ip2hosts-0.4.tar.gz && cp bing-ip2hosts-0.4/bing-ip2hosts /usr/local/bin/")				
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Vulnerability Analysis tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in bbqsql bed cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-torch copy-router-config doona dotdotpwn greenbone-security-assistant hexorbase jsql lynis nmap ohrwurm openvas-cli openvas-manager openvas-scanner oscanner powerfuzzer sfuzz sidguesser siparmyknife sqlmap sqlninja sqlsus thc-ipv6 tnscmd10g unix-privesc-check yersinia; do apt-get -f install -y $i; done")						
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Wireless Attacks tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in aircrack-ng asleap bluelog blueranger bluesnarfer bully cowpatty crackle eapmd5pass fern-wifi-cracker ghost-phisher giskismet gqrx kalibrate-rtl killerbee kismet mdk3 mfcuk mfoc mfterm multimon-ng pixiewps reaver redfang spooftooph wifi-honey wifitap wifite; do apt-get -f install -y $i; done")
							elif opcion2 == "back":
								inicio()
							elif opcion2 == "gohome":
								inicio1()						
...
0) Install all Web Applications tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in apache-users arachni bbqsql blindelephant burpsuite cutycapt davtest deblaze dirb dirbuster fimap funkload grabber jboss-autopwn joomscan jsql maltego-teeth padbuster paros parsero plecost powerfuzzer proxystrike recon-ng skipfish sqlmap sqlninja sqlsus ua-tester uniscan vega w3af webscarab websploit wfuzz wpscan xsser zaproxy; do apt-get -f install -y $i; done")												
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "5":
							print ('''
...
0) Install all Sniffing & Spoofing tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in burpsuite dnschef fiked hamster-sidejack hexinject iaxflood inviteflood ismtp mitmproxy ohrwurm protos-sip rebind responder rtpbreak rtpinsertsound rtpmixsound sctpscan siparmyknife sipp sipvicious sniffjoke sslsplit sslstrip thc-ipv6 voiphopper webscarab wifi-honey wireshark xspy yersinia zaproxy; do apt-get -f install -y $i; done")  
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Maintaining Access tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in cryptcat cymothoa dbd dns2tcp http-tunnel httptunnel intersect nishang polenum powersploit pwnat ridenum sbd u3-pwn webshells weevely; do apt-get -f install -y $i; done")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "7":
							print ('''
...
0) Install all Reporting Tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in casefile cutycapt dos2unix dradis keepnote magictree metagoofil nipper-ng pipal; do apt-get -f install -y $i; done")  
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Exploitation Tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in armitage backdoor-factory cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-torch crackle jboss-autopwn linux-exploit-suggester maltego-teeth set shellnoob sqlmap thc-ipv6 yersinia beef-xss; do apt-get -f install -y $i; done")  						
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Forensics Tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in binwalk bulk-extractor chntpw cuckoo dc3dd ddrescue dumpzilla extundelete foremost galleta guymager iphone-backup-analyzer p0f pdf-parser pdfid pdgmail peepdf volatility xplico; do apt-get -f install -y $i; done")						
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "10":
							print ('''
...
0) Install all Stress Testing tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in dhcpig funkload iaxflood inviteflood ipv6-toolkit mdk3 reaver rtpflood slowhttptest t50 termineter thc-ipv6 thc-ssl-dos; do apt-get -f install -y $i; done")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "11":
							print ('''
...
0) Install all Password Attacks tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in acccheck burpsuite cewl chntpw cisco-auditing-tool cmospwd creddump crunch findmyhash gpp-decrypt hash-identifier hexorbase john johnny keimpx maltego-teeth maskprocessor multiforcer ncrack oclgausscrack pack patator polenum rainbowcrack rcracki-mt rsmangler statsprocessor thc-pptp-bruter truecrack webscarab wordlists zaproxy; do apt-get -f install -y $i; done")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "12" :
							print ('''
...
0) Install all Reverse Engineering tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in apktool dex2jar python-diStorm3 edb-debugger jad javasnoop JD OllyDbg smali Valgrind YARA; do apt-get -f install -y $i; done")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "13" :
							print ('''
...
0) Install all Hardware Hacking tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("for i in android-sdk apktool arduino dex2jar sakis3g smali; do apt-get -f install -y $i; done")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "14" :
							print ('''
